...
export default function RSVPForm() {
  ...
  return (
    <section id="confirmacion" className="relative py-32 px-4 sm:px-6 bg-[#FAF6F0] overflow-hidden">
      ...
      <div className="max-w-2xl mx-auto relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          >
            ...
            <p className="text-[#1B365D]/80 text-sm font-serif italic mt-5 max-w-sm leading-relaxed">
              {t("rsvp.desc")}
            </p>
          </motion.div>
        </div>
        ...
        <motion.div
          ...
          className="bg-white border-2 border-[#dfb559]/30 rounded-2xl p-8 sm:p-12 shadow-[0_15px_45px_rgba(27,54,93,0.06)] relative overflow-hidden"
        >
          ...
          {isSuccess ? (
            ...
            >
              ...
              <p className="text-[#1B365D]/75 text-xs sm:text-sm font-light max-w-sm leading-relaxed mb-8">
                {t("rsvp.success_desc")}
              </p>
              <button
            ...
            <form onSubmit={handleSubmit} className="space-y-6 relative z-10 text-left">
              ...
              <div>
                <label htmlFor="nombre" className="block text-[10px] uppercase tracking-[0.2em] font-bold text-[#1B365D] mb-2">
                ...
                <input
                  ...
                  className="w-full px-5 py-3.5 rounded-lg border border-[#E5E1D8] bg-[#FAF6F0] focus:bg-white text-[#1B365D] text-xs sm:text-sm font-medium select-text outline-none transition-all focus:border-[#dfb559] focus:ring-0"
                />
              </div>

              {/* Field 2: Companions Count */}
              <div>
                <label htmlFor="asistentes" className="block text-[10px] uppercase tracking-[0.2em] font-bold text-[#1B365D] mb-2">
                  {t("rsvp.guests_label")}
                </label>
                ...
                {formData.asistentes === "manual" && (
                  <motion.div
                    ...
                    className="mt-3.5"
                  >
                    <label htmlFor="manualAsistentes" className="block text-[10px] uppercase tracking-[0.2em] font-bold text-[#1B365D] mb-2">
              ...
              <div className="flex flex-col items-center justify-center pt-6 select-none">
                ...
                <span className="text-[11px] uppercase tracking-[0.2em] font-bold text-[#1B365D] mt-4 text-center">
