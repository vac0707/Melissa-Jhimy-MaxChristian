...
export default function RSVPPage() {
  ...
  const handleSubmit = (e: FormEvent) => {
    ...
    if (lang === "es") {
      if (asistencia === "si") {
        mensaje = `💍🕊️🎂 *CONFIRMACIÓN DE ASISTENCIA* 🎂🕊️💍\n*Boda de Melissa & Jhimy, Bautizo y Primer Año de Max Christian*\n📅 *Fecha:* Lunes, 7 de Setiembre 2026\n📍 *Lugar:* Abancay, Perú\n\n✨ *¡Hola Melissa y Jhimy!* ✨\nCon mucha alegría y emoción confirmo mi asistencia para celebrar junto a ustedes su Matrimonio, Bautizo y el Primer Año de Max Christian en este día tan bendecido y especial. 🥂🎉\n\n📋 *DETALLES:* \n👤 *Invitado(s):* ${nombre.trim()}\n👥 *Pases / Asistentes:* ${totalPersonas} persona(s)\n✅ *Estado:* ¡Confirmado con mucha alegría!\n\n¡Nos vemos pronto para celebrar su amor, el bautizo y el primer añito! 💖✨🍾🎂`;
      } else {
        mensaje = `💍🕊️🎂 *RESPUESTA DE ASISTENCIA* 🎂🕊️💍\n*Boda de Melissa & Jhimy, Bautizo y Primer Año de Max Christian*\n\n✨ *¡Hola Melissa y Jhimy!* ✨\nMuchas gracias por la hermosa invitación. Lamentablemente no podré acompañarlos en esta ocasión, pero les envío todo mi cariño y mejores deseos para su Boda, el Bautizo y el Primer Año de Max Christian. 🤍🙏\n\n📋 *DATOS:* \n👤 *Nombre:* ${nombre.trim()}\n❌ *Estado:* No podré asistir\n\n¡Que Dios bendiga siempre su sagrada unión matrimonial, y el Bautizo y Primer Año de Max Christian con mucho amor y felicidad! 🕊️💖✨`;
      }
    } else {
      if (asistencia === "si") {
        mensaje = `💍🕊️🎂 *RSVP CONFIRMATION* 🎂🕊️💍\n*Melissa & Jhimy's Wedding, Baptism & 1st Birthday of Max Christian*\n📅 *Date:* Monday, September 7, 2026\n📍 *Location:* Abancay, Peru\n\n✨ *Hello Melissa & Jhimy!* ✨\nI am thrilled to confirm my attendance to celebrate your Wedding, Baptism & 1st Birthday of Max Christian together on this blessed day! 🥂🎉\n\n📋 *DETAILS:* \n👤 *Guest Name:* ${nombre.trim()}\n👥 *Passes / Attendees:* ${totalPersonas} person(s)\n✅ *Status:* Confirmed!\n\nSee you soon to celebrate together! 💖✨🍾🎂`;
      } else {
        mensaje = `💍🕊️🎂 *RSVP RESPONSE* 🎂🕊️💍\n*Melissa & Jhimy's Wedding, Baptism & 1st Birthday of Max Christian*\n\n✨ *Hello Melissa & Jhimy!* ✨\nThank you so much for the lovely invitation. Unfortunately I won't be able to attend, but I send you all my love and best wishes for your Wedding, Baptism & 1st Birthday of Max Christian. 🤍🙏\n\n📋 *DETAILS:* \n👤 *Name:* ${nombre.trim()}\n❌ *Status:* Cannot attend\n\nMay God bless your marriage, baptism and 1st birthday celebration with immense love and happiness! 🕊️💖✨`;
      }
    }
