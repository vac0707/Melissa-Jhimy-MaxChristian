    ...
    <section className="relative min-h-[100svh] w-full py-10 sm:py-14 px-4 sm:px-6 bg-[#FAF6F0] flex flex-col justify-center items-center overflow-hidden">
      ...
      <div className="max-w-xl w-full text-center relative z-10 flex flex-col items-center my-auto">
        ...
        >
          ...
          <h3 className="font-great-vibes text-5.5xl sm:text-7xl text-[#1B365D] tracking-wide font-normal mb-1 leading-none select-none">
        ...
        <motion.div
          ...
          className="w-full max-w-md bg-[#132742] text-white rounded-2xl py-4 px-4 sm:px-6 border border-[#dfb559]/40 shadow-lg mb-6 relative overflow-hidden"
        >
          <div className="grid grid-cols-[1fr_auto_1fr_auto_1fr_auto_1fr] items-center text-white">
            {/* DAYS */}
            <div className="flex flex-col items-center">
              <span className="font-sans text-3xl sm:text-4xl font-light tracking-tight select-none leading-none">
                {padZero(timeLeft.days)}
              </span>
              <span className="text-[9px] sm:text-[10px] tracking-[0.2em] text-[#dfb559] uppercase mt-2 font-semibold">
                {lang === "es" ? "DÍAS" : "DAYS"}
              </span>
            </div>
            ...
            <div className="flex items-center justify-center">
              <span className="text-xl sm:text-2xl font-light text-white/30 select-none pb-3">:</span>
            </div>
            ...
            {/* SECONDS */}
            <div className="flex flex-col items-center">
              <span className="font-sans text-3xl sm:text-4xl font-light tracking-tight text-[#dfb559] select-none leading-none">
        ...
        <motion.div
          ...
          className="w-full max-w-sm mx-auto bg-white/90 rounded-2xl p-4 sm:p-5 shadow-[0_10px_30px_rgba(27,54,93,0.06)] border border-[#dfb559]/30 relative text-[#1B365D]"
        >
          {/* Month Header */}
          <div className="text-center mb-3">
            <h4 className="font-serif text-[14px] sm:text-[16px] text-[#1B365D] tracking-[0.2em] font-bold uppercase">
              {lang === "es" ? "SETIEMBRE 2026" : "SEPTEMBER 2026"}
            </h4>
          </div>

          {/* Calendar Grid */}
          <div className="grid grid-cols-7 gap-1 text-center relative z-20 text-[11px] sm:text-xs">
            {/* Weekdays Header */}
            {(lang === "es"
              ...
              <span
                key={idx}
                className="font-great-vibes text-[15px] text-[#c5a059] pb-1 font-semibold"
              >
                {day}
              </span>
            ))}
            ...
            {[
                ...
                return (
                  ...
                  >
                    <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                      <svg viewBox="0 0 24 24" fill="#1B365D" className="w-8 h-8 drop-shadow text-[#1B365D] animate-pulse">
                        <path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z" />
                      </svg>
                    </div>

                    <span className="relative z-10 text-[10.5px] font-extrabold text-[#FAF6F0] leading-none">
                      7
                    </span>
                  </div>
                );
              ...
              return (
                <div
                  key={idx}
                  className="aspect-square flex items-center justify-center rounded-full text-[12px] font-serif text-[#1B365D]/80"
                >
                  <span>{item.day}</span>
                </div>
              );
          ...
          <div className="mt-3 pt-2.5 border-t border-[#dfb559]/30 text-center">
            <p className="font-serif text-[12.5px] sm:text-[13.5px] font-bold tracking-wide text-[#1B365D]">
              {lang === "es" ? "Lunes, 7 de Setiembre • 02:00 PM" : "Monday, September 7 • 02:00 PM"}
            </p>
            <p className="text-[9.5px] text-[#c5a059] uppercase tracking-[0.25em] font-bold mt-0.5 inline-flex items-center gap-1">
