    ...
    <section className="relative min-h-[100svh] w-full py-12 sm:py-16 px-4 sm:px-6 bg-[#FAF6F0] overflow-hidden select-none flex flex-col justify-center items-center">
      ...
      <div className="max-w-4xl w-full mx-auto relative z-10 my-auto">
        ...
        >
          ...
          <h2 className="font-great-vibes text-4xl sm:text-6xl text-[#1B365D] leading-none mb-2">
            {lang === "es" ? "Captura y Comparte Cada Momento" : "Capture & Share Every Moment"}
          </h2>

          <p className="font-serif text-xs sm:text-sm text-[#1B365D]/80 max-w-xl mx-auto leading-relaxed font-light italic">
            {lang === "es"
          ...
          <div className="w-20 h-[1px] bg-gradient-to-r from-transparent via-[#dfb559] to-transparent mx-auto mt-3" />
        </motion.div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-center relative z-10">
            ...
            <div className="lg:col-span-5 flex flex-col items-center text-center">
              <div className="relative p-3.5 bg-[#FAF6F0] rounded-2xl border-2 border-[#dfb559]/70 shadow-md">
                ...
                <div className="mt-2 flex items-center justify-center gap-1 text-[10px] font-serif font-bold text-[#1B365D] tracking-wider uppercase">
              ...
              <div className="flex items-center gap-2 mt-3">
                <button
                  ...
                  className="px-2.5 py-1.5 rounded-full bg-[#FAF6F0] hover:bg-[#1B365D] text-[#1B365D] hover:text-white border border-[#dfb559]/50 text-[11px] font-serif font-bold flex items-center gap-1 transition-all cursor-pointer shadow-xs"
                >
            ...
            <div className="lg:col-span-7 flex flex-col justify-between h-full space-y-4">
              <div>
                <h3 className="font-serif font-bold text-lg sm:text-xl text-[#1B365D]">
                  {lang === "es" ? "Categorías del Álbum" : "Album Categories"}
                </h3>
                <p className="text-[11px] sm:text-xs text-[#1B365D]/75 mt-0.5 font-medium">
                  {lang === "es"
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-1.5 sm:gap-2">
                {CATEGORIES.map((cat) => (
                  <div
                    key={cat.id}
                    className="p-2 rounded-xl bg-[#FAF6F0]/80 border border-[#dfb559]/30 flex items-center gap-1.5 hover:border-[#dfb559] transition-all"
                  >
                    <div className="p-1 rounded-lg bg-[#1B365D] text-[#dfb559] flex-shrink-0">
                      {getCatIcon(cat.id)}
                    </div>
                    <p className="font-serif font-bold text-[11px] sm:text-xs text-[#1B365D] truncate">
                      {cat.label}
                    </p>
                  </div>
                ))}
              ...
              {/* Live counter badge */}
              <div className="flex items-center gap-2.5 p-2.5 rounded-xl bg-[#1B365D]/5 border border-[#dfb559]/30">
                <div className="w-8 h-8 rounded-full bg-[#1B365D] text-[#dfb559] flex items-center justify-center flex-shrink-0 font-bold text-xs">
                  {photoCount}
                </div>
                <div>
                  ...
                  <p className="text-[10px] text-[#1B365D]/70">
              ...
              <div>
                <button
                  ...
                  className="w-full py-3 px-5 rounded-full bg-[#132742] hover:bg-[#1B365D] text-[#dfb559] border border-[#dfb559]/60 font-sans font-bold text-xs uppercase tracking-[0.2em] shadow-md hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center justify-center gap-2 cursor-pointer"
                >
