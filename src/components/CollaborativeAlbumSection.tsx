        ...
        >
          ...
          <p className="font-serif text-[16px] sm:text-[18px] text-[#1B365D] max-w-xl mx-auto leading-relaxed font-normal italic px-2">
            {lang === "es"
              ...
              : "We want to see our wedding, first birthday, and Max Christian's baptism through your eyes. Scan the QR code or click below to upload your photos organized by category."}
          </p>
